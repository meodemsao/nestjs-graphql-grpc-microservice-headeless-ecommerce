...
import { Hook, HookTypes } from '@vg/query-graphql'
import { getHookForType } from '@vg/query-graphql/decorators'
import { getHookToken } from '@vg/query-graphql/hooks'
