...
@Entity('manufacturer')
export class ManufacturerEntity extends BaseEntity<any> {
  ...
  @Column('enum', { name: 'status', nullable: false, default: ManufacturerStatus.Active, enum: ManufacturerStatus })
